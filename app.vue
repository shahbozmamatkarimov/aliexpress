<template>
  <div>
    <header class="relative z-50">
      <nav class="fixed bg-white flex justify-center w-full sm:p-3 p-4">
        <button class="bg-[red] rounded-full sm:text-5xl text-4xl py-[20px] px-[30%]">
          <i>AliExpress</i>
        </button>
      </nav>
    </header>
    <div>
      ...
      <button
        ...
        type="button"
        class="fixed inline-flex z-50 items-center p-3 mt-5 bg-white ml-3 text-sm text-gray-500 rounded-lg sm:hidden bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
      ...
      <aside
        ...
        class="fixed top-28 left-0 z-40 w-60 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div
      ...
      <div class="p-4 sm:ml-64">
        <div class="sm:ml-0 ml-16 pb-2 fixed bg-white w-[80%] sm:w-[calc(100vw-300px)]">
          <form>
            <label
              for="default-search"
        ...
        <div
          class="p-4 mt-20 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700"
        >
          <div class="flex flex-wrap justify-around gap-4 mb-4">
            <div
              class="flex items-center justify-center h-42 rounded lg:h-[180px] lg:w-[280px] md:h-[120px] md:w-[200px] bg-gray-50 dark:bg-gray-800"
              v-for="i in 12"
              :key="i"
            >
              <img
